...
<template>
    <nav class="d-flex justify-content-center mt-3">
        <ul class="pagination">
            <li class="page-item">
                <inertia-link class="page-link" :href="items.first_page_url + (query ? '&query=' + query : '')"
                              preserve-scroll>
            ...
            <li class="page-item" v-if="items.prev_page_url">
                <inertia-link class="page-link" :href="items.prev_page_url + (query ? '&query=' + query : '')"
                              preserve-scroll>
            ...
            <template v-for="i in [5,4,3,2,1]">
                <li v-if="items.current_page - i > 0" class="page-item">
                    <inertia-link :href="items.links[items.current_page - i].url + (query ? '&query=' + query : '')"
                                  class="page-link"
                                  preserve-scroll>
            ...
            <li class="page-item" v-if="items.next_page_url">
                <inertia-link class="page-link" :href="items.next_page_url + (query ? '&query=' + query : '')"
                              preserve-scroll>
            ...
            <li class="page-item">
                <inertia-link class="page-link" :href="items.last_page_url + (query ? '&query=' + query : '')"
                              preserve-scroll>
